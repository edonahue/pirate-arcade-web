...
| **Nautical chart overlay**      | `src/components/ChartOverlay.astro`                    | Inline SVG      | Hand-authored (compass rose, rhumb lines, X marks, mermaid, treasure chest) | Review positioning when layout changes                         |
...
Only browser-playable games have committed screenshots, captured via
`scripts/capture-browser-game-screenshots.mjs`.
