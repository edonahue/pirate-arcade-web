...
PADDLE_BREAKOUT_WIDE_MULTIPLIER = 1.6
PADDLE_BREAKOUT_WIDE_DURATION = 8.0

BALL_BREAKOUT_SIZE = 10
BALL_BREAKOUT_SPEED = 650
BALL_BREAKOUT_MAX_SPEED = 800
BALL_BREAKOUT_SPEED_INCREMENT = 0.02

BALL_BREAKOUT_SLOW_FACTOR = 0.72
BALL_BREAKOUT_SLOW_DURATION = 6.0
...
# Stage speeds — each stage starts faster
STAGE_START_SPEEDS = {1: 650, 2: 700, 3: 750}
...
# Reinforced brick
REINFORCED_HEALTH = 2
REINFORCED_POINTS_MULTIPLIER = 3

# Powder keg
POWDER_KEG_EXPLOSION_RADIUS = 1
POWDER_KEG_POINTS = 25
POWDER_KEG_CHAIN_MAX = 20

# Treasure brick
TREASURE_BRICK_POINTS = 50
PICKUP_TYPES = ["multiball", "wide_paddle", "slow_motion"]

# Falling pickups
PICKUP_SIZE = 20
PICKUP_FALL_SPEED = 180
PICKUP_LIFETIME = 8.0
PICKUP_COLLECT_BONUS = 100
MAX_BALLS = 3
