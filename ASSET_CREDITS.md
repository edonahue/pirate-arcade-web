...
| File                                     | Source                        | License       | Notes                                                                                                                                                                          |
| ---------------------------------------- | ----------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ship-player` / `ship-ai` (BootScene.ts) | Generated (Phaser procedural) | Original work | 80×100 textures generated at boot by `BootScene.ts` via Phaser Graphics API. Player: white sails, gold stripe, gold flag. Rival: cream sails, red stripe, red flag with cross. |
